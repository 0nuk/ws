...
// PARTE 1 - MUESTRA PASO A PASO INSERCION
//		pruebaInsercion(numeros);

		System.out.println();

// PARTE 2 - MUESTRA PASO A PASO BURBUJA
//		numeros = new double[] {8, 5, 6, 7, 1, 8, 5};
//		pruebaBurbuja(numeros);
		
		
		
// PARTE 3 - COMPARA TODOS CON ARRAY DESORDENADO, AL REVES Y ORDENADO		
//		numeros = new double[] {8, 5, 6, 7, 1, 8, 5};
//		compara(numeros);
//		
//		System.out.println("------------------------");
...
// PARTE 4 - COMPARA TODOS CON ARRAYS MAS GRANDES
...
// PARTE 5 - COMPARATIVA QUICKSORT RECURSIVO Y EL DE LIBRERIA (ITERATIVO)		
