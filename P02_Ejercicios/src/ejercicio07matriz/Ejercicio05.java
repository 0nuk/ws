...
public class Ejercicio05 {
	public static double[] sumaColumna(double[][] matriz) {
	...
	public static void main(String[] args) {
		...
		ejercicio06array.Muestra01.print(sumaColumna((matriz)));
		System.out.println("---------------");
